...
HD_PWD='C:/Users/admin/Desktop/Hardware-Serpent-Cyphering/Hardware_serpent_cyphering/Hardware_serpent_cyphering.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log General_State_machine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source General_State_machine.tcl -notrace
